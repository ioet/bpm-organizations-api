package com.ioet.bpm.organizations.aws.handler;
...
import com.ioet.bpm.organizations.BpmOrganizationsApiApplication;
...
public class AwsLambdaHandler implements RequestStreamHandler {
    ...
    public AwsLambdaHandler() throws ContainerInitializationException {
        handler = SpringBootLambdaContainerHandler.getAwsProxyHandler(BpmOrganizationsApiApplication.class);
    }
